...
namespace Agricultura_práctica_final
{
    public partial class Form1 : Form
    {
        ...
        {
            if (cmbLocalidad.Items.Count > 0 &&  lstCultivo.Items.Count > 0 && txtProduccion.Text != "")
            {
                try
                {
                    ...
                    prod.Dispose();
                    MessageBox.Show("Registro actualizado", "Actualizar Producción", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
